...
<head>
  ...
  <title>Peridzinan Santri | Dashboard</title>
...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="<?php echo base_url();; ?>/assets/dist/img/PermissionLogo.png" alt="PermissionLogo" height="60" width="60">
  </div>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2023 <a href="https://adminlte.io">indahvitasari943@gmail.com</a>.</strong>
    All rights reserved.
    <div class="float-right d-none d-sm-inline-block">
      <b>PeridzinanSantri</b>
    </div>
  </footer>
